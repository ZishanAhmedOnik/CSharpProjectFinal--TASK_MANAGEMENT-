    ...
    public partial class LoginForm : Form
    {
        ...
        private void LoginButton_Click(object sender, EventArgs e)
        {
            ...
            if(loggedInUser != null)
            {
                ...
                this.Text = loggedInUser.USER_NAME;
            ...
            if(loggedInUser != null && loggedInUser.USER_ROLE == "Regular")
            {
        ...
        {
            AddTaskForm addTask = new AddTaskForm(loggedInUser, taskDataGridView, gridItemList);
            addTask.Show();
        }
        ...
        private void timer1_Tick(object sender, EventArgs e)
        {
            if (loggedInUser != null)
            {
                //MessageBox.Show("adaadad");
                //NotifyUser();
                var result = from task in taskData.QueryAll()
                             where task.USER_ID == loggedInUser.USER_ID
                             select task;
        ...
        private void NotifyUser()
        {
            ...
            notifyIcon1.BalloonTipTitle = "Task Management";
            notifyIcon1.BalloonTipText = "New Task Added";
            notifyIcon1.ShowBalloonTip(3000);
        }
